...
export default function Contact() {
  const socialLinks = [
    { name: 'GitHub', handle: '@Ayungcodes', url: 'https://github.com/Ayungcodes', icon: '🐙' },
    { name: 'LinkedIn', handle: 'Gaius Emmanuel', url: 'https://www.linkedin.com/in/gaius-emmanuel-b10279202/', icon: '💼' },
    { name: 'X / Twitter', handle: '@_Gaius_Emmanuel', url: 'https://x.com/_Gaius_Emmanuel', icon: '🐦' },
    { name: 'Instagram', handle: '@ayungclassic', url: 'https://www.instagram.com/ayungclassic/', icon: '📸' },
  ]
  ...
  return (
    <section id="contact" className="py-28 px-6 bg-white text-stone-900 dark:bg-black dark:text-stone-200 border-t border-stone-100 dark:border-stone-950 relative overflow-hidden">
          ...
          <div className="lg:col-span-6 space-y-12">
            <motion.div variants={itemVariants} className="space-y-4">
              ...
              <h2 className="text-4xl sm:text-6xl font-black tracking-tight leading-none text-stone-950 dark:text-white">
                Let’s create <br />something <span className="text-yellow-600">real.</span>
              </h2>
              <p className="max-w-md text-stone-600 dark:text-stone-400 text-base sm:text-lg leading-relaxed pt-2">
                Whether you have a groundbreaking application to engineer, a project that needs a clean architecture, or simply want to speak concept—my door is always open.
              </p>
            </motion.div>

            {/* direct lines */}
            <motion.div variants={itemVariants} className="space-y-6 pt-4 border-t border-stone-100 dark:border-stone-900 max-w-md">
              ...
              >
                ...
                <span className="text-lg sm:text-xl font-bold text-stone-950 dark:text-white group-hover:text-yellow-600 transition-colors duration-200 mt-1 flex items-center gap-2">
                  +234 701 137 2616 
                  <span className="text-xs bg-emerald-500/10 text-emerald-500 px-2 py-0.5 rounded font-mono font-normal">Active</span>
                </span>
              </a>
              ...
              {socialLinks.map((social) => (
                ...
                >
                  <div className="flex justify-between items-start">
                    ...
                    <span className="text-xs font-semibold text-stone-400 dark:text-stone-600 group-hover:text-yellow-600 transition-colors duration-200">
                      Connect ↗
                    </span>
                  </div>
